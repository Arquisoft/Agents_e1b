...
public class MainTest {
	...
	public void T5agentDoNotExist() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST("persona69", "shcxhqw", 2),
				String.class);
		assertThat(response.getBody(), equalTo(userNotFound));
	}
	...
	@Test
	public void T25idChangeCorrect() {
		ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
		String userURI = base.toString() + "/changeId";
	...
	@Test
	public void T26correctPasswordChange() {
		ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
		String userURI = base.toString() + "/changePassword";
	...
	@Test
	public void T27correctPasswordChangeXML() {
		ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
		String userURI = base.toString() + "/changePassword";
	...
	@Test
	public void T28idChangeCorrectXML() {
		ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
		String userURI = base.toString() + "/changeId";
		String correctChange = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
